...
```
A:\PMCR-O\.pmcro\PMCRO.md
A:\PMCR-O\.pmcro\identity.json
A:\PMCR-O\.pmcro\laws\colony-laws.md
A:\PMCR-O\docs\index.md
A:\PMCR-O\docs\articles\anthropic-maf-alignment.md
A:\PMCR-O\skills\pmcro-framework\SKILL.md
A:\PMCR-O\skills\framework-evolution\SKILL.md  (this file)
```
...
For each EarnedConstraint in alignment_report:
  → Write to .pmcro/constraints/evolution-{date}/
  → If action = NEW-LAW: create draft in .pmcro/laws/candidates/
...
Bump ThoughtLock across:
  .pmcro/PMCRO.md
  .pmcro/identity.json
  skills/framework-evolution/SKILL.md
```
